        ...
        <div class="px-6 pt-6 lg:px-8">
            <nav class="flex items-center justify-between" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="./login.php" class="text-sm font-semibold leading-6 text-gray-900">Donate Blood</a>

                    <a href="../details.php" class="text-sm font-semibold leading-6 text-gray-900">Generate
                        Certificate</a>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="space-y-2 py-6">
                                ...
                                <a href="#" class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Blood</a>
            ...
            <div class="relative px-6 lg:px-8">
                <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div class="text-center">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Welcome! Blood Bank User
                        </h1>
