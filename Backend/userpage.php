        ...
        <div class="px-6 pt-6 lg:px-8">
            <nav class="flex items-center justify-between" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Fill Donation form</a>

                    <a href="./listreport.php" class="text-sm font-semibold leading-6 text-gray-900">
                        View Certificate </a>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="space-y-2 py-6">
                                ...
                                <a href="#"
                                    class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Fill
                                    Donation
                                    Form</a>
                    ...
                    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                            <div
                                ...
                                Announcing our next round of donation. <a href="#"
                                    class="font-semibold text-red-600"><span class="absolute inset-0"
                                        aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
                            </div>
                        </div>
                        <div class="text-center">
                            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">One Blood Donation
                                can
                                save upto Three lives</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-600">Pledge to make an impact this year. Donate
                                Blood
                            </p>
                            <div class="mt-10 flex items-center justify-center gap-x-6">
                                <a href="./listreport.php"
                                    class="rounded-md bg-red-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Get
                                    Certificate</a>
