...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($err) && strlen($username)) {
        $sql = "SELECT  username, password, name FROM blood.admin WHERE username = \"" . $username . "\";";
            ...
            <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-md space-y-8">
                    <div>
                        ...
                        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Admin Sign in Account
                        </h2>
