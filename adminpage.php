        ...
        <div class="px-6 pt-6 lg:px-8">
            <nav class="flex items-center justify-between" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Donate Blood</a>

                    <a href="./registerbloodbank.html" class="text-sm font-semibold leading-6 text-gray-900">Create
                        Blood Bank User</a>

                    <a href="#" class="text-sm font-semibold leading-6 text-gray-900">View Report(s)</a>
                </div>
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="./Backend/logout.php" class="text-sm font-semibold leading-6 text-gray-900">Log out <span
