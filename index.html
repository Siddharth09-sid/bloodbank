...
<head>
    ...
    <title>National Blood Donation</title>
</head>
...
<body>
        ...
        <div class="px-6 pt-6 lg:px-8">
            <nav class="flex items-center justify-between" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="./Backend/login.php" class="text-sm font-semibold leading-6 text-gray-900">Donor Login</a>

                    <a href="./Backend/bloodbanklogin.php" class="text-sm font-semibold leading-6 text-gray-900">Blood
                        Bank Login</a>

                    <a href="./Backend/adminlogin.php" class="text-sm font-semibold leading-6 text-gray-900">Admin</a>
                </div>
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="./Backend/login.php" class="text-sm font-semibold leading-6 text-gray-900">Log in <span
            ...
            <div role="dialog" aria-modal="true">
                <div focus="true" class="fixed inset-0 z-10 overflow-y-auto bg-white px-6 py-6 lg:hidden">
                    <div class="flex items-center justify-between">
                        <a href="#" class="-m-1.5 p-1.5">
                            <span class="sr-only">Blood Donation</span>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="space-y-2 py-6">
                                <a href="#"
                                    class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">About</a>

                                <a href="#"
                                    class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Donate
                                    Blood</a>

                                <a href="#"
                                    class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Blood
                                    Bank</a>
                ...
                <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                        <div
                            ...
                            Announcing our next round of donation. <a href="#" class="font-semibold text-red-600"><span
                                    class="absolute inset-0" aria-hidden="true"></span>Read more <span
                                    aria-hidden="true">&rarr;</span></a>
                        </div>
                    </div>
                    <div class="text-center">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">One Blood Donation can
                            save upto Three lives</h1>
                        ...
                        <div class="mt-10 flex items-center justify-center gap-x-6">
                            <a href="./Backend/login.php"
                                class="rounded-md bg-red-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Donate
                                Blood</a>
    ...
    <footer class="text-center bg-gray-400 text-white">
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2023 Copyright:
            <a class="text-white" href="https://tailwind-elements.com/">National Blood Donation Bank</a>
        </div>
    </footer>
</body>
